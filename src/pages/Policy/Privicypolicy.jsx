...
const Privicypolicy = () => {
  return (
    <div id="policy_page">
      <div id="policy-bar_content">
        <div className="item">
          <h2 className="company_title">SVC & ASSOCIATES privacy policy</h2>
          <p className="company_descriptoin">
        ...
        <div className="item">
          ...
          "Us" or "Our" in this Agreement) refers to SVC & ASSOCIATES, 128
          ...
          <p>
            <strong>Website</strong> refers to SVC & ASSOCIATES, accessible from
          </p>
          <a href="https://webappssoft.com/">https://webappssoft.com/</a>
          <p>
        ...
        <div className="item">
          ...
          <p>
            ...
            <span className="green"> All About Cookies by TermsFeed</span> .
          </p>
          <p>
        ...
        <div className="item">
          ...
          <ul>
            <li>
              ...
              improvement of our Service. <strong>Google Places</strong> Google
              Places is a service that returns information about places using
